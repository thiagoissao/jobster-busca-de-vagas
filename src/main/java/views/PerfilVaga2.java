 ...
 * @author thiago
 */
public class PerfilVaga2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("- We need DevSecOps engineers!");

        jLabel14.setBackground(new java.awt.Color(9, 9, 9));
        jLabel14.setForeground(new java.awt.Color(5, 5, 5));
        jLabel14.setText("- The pay is way higher than avarege!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilVaga2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilVaga2().setVisible(true);
            }
        });
    }
