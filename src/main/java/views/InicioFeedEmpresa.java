 ...
 * @author thiago
 */
public class InicioFeedEmpresa extends javax.swing.JFrame {

    /**
     * Creates new form Inicio
     */
    public InicioFeedEmpresa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("A new user applied for the “Marketing Manager” offer!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioFeedEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioFeedEmpresa().setVisible(true);
            }
        });
    }
