 ...
 * @author thiago
 */
public class VisualizacaoVaga extends javax.swing.JFrame {

    /**
     * Creates new form Inicio
     */
    public VisualizacaoVaga() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Offer xxxx from TechnoCorp S/A");
        ...
        jLabel4.setText("This is the description for job offer xxxx from TechnoCorp S/A:");
        ...
        jLabel7.setBackground(new java.awt.Color(9, 9, 9));
        jLabel7.setForeground(new java.awt.Color(5, 5, 5));
        jLabel7.setText("- The pay is higher than avarege!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizacaoVaga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizacaoVaga().setVisible(true);
            }
        });
    }
